...
library(sdam)
source("C:/R/AUArts/sdam-pub/edhw.r")
```
...
edhs = request("EDH_attrs_cleaned_2020-09-30.json", path="/sharingin/648597@au.dk/SDAM_root/SDAM_data/EDH/public", method="GET", cred=cred)
edhw(x=edhs, vars=c("type_of_inscription","people"), as="df")
